...
if (!$_SESSION["loggedin"]) {
                        ...
                        <div class="col-lg-10 col-sm-9">
                            <div class="timeline-info">
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="friends_center.php" title="" data-ripple="">Friends
                                            Center</a>
                                        <a class="" href="edit_profile.php" title="" data-ripple="">Edit
                                            Profile</a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="frnds">
                                            <ul class="nav nav-tabs">
                                                <li class="nav-item"><a class="" href="#frends" data-toggle="tab">My
                                                        Friends </a><span id="frnds_counter"></span>
                                                </li>
                                                <li class="nav-item"><a class="active" href="#frends-req"
                                                        data-toggle="tab">Friend Requests</a><span
                                                        id="frnd_req_counter"></span>
                                                </li>
                                                <li class="nav-item"><a class="" href="#pending_frends"
                                                        data-toggle="tab">Pending Friends</a><span
                                                        id="pending_frds_counter"></span>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade" id="frends">
                                                    <ul class="nearby-contct" id="frnds_container">

                                                    </ul>
                                                </div>

                                                <div class="tab-pane active fade show" id="frends-req">
                                                    <ul class="nearby-contct" id="frnd_req_container">

                                                    </ul>
                                                </div>

                                                <div class="tab-pane fade" id="pending_frends">
                                                    <ul class="nearby-contct" id="pending_frds_container">
    ...
    <script src="js/load_my_profile.js"></script>
</body>
