...
<section class="">
	<div class="page-header">
		<div class="row">
			...
			<div class="col-6 ">
				<form class="d-flex">
					<input id="srch_bar" class="form-control me-2" type="search" placeholder="Search for Users"
						aria-label="Search">
					<button id="srch_btn" class="btn btn-outline-primary" type="button">Search</button>
				</form>
			</div>
		</div>
	</div>
